      ...
      <div className="header-content">
        <div className="header-left">
          ...
          <nav className="main-nav">
            <Link to="/" className={`nav-item ${location.pathname === '/' ? 'active' : ''}`}>홈</Link>
            <Link to="/messages" className={`nav-item ${location.pathname === '/messages' ? 'active' : ''}`}>메시지</Link>
          </nav>
        </div>
        ...
        <div className="header-right">
          ...
          <div className="profile-menu">
            ...
            >
              <img src="/api/placeholder/40/40" alt="Profile" className="profile-avatar" />
